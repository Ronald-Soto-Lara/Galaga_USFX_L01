...
#include "ImplementationConcrect.generated.h"

UCLASS()
class GALAGA_USFX_L01_API AImplementationConcrect : public AActor, public IImplemetation
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AImplementationConcrect();
